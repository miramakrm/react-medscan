...
import styles from "../PatientSetPassword/PatientSetPassword.module.css";
import doctorImg from "../../../assets/images/patientImages/patient.png";
      ...
      <div className={styles.container}>
        ...
        <form onSubmit={handleSubmit}>
          <div className={styles.passwordField}>
            ...
            >
              <FontAwesomeIcon
                icon={passwordVisible.create ? faEyeSlash : faEye}
              />
            </span>
            {passwords.create && (
              <p
                className={`${styles.strengthText} ${
                  styles[getStrengthText()]
                }`}
              >
          ...
          <div className={styles.passwordField}>
            ...
            >
              <FontAwesomeIcon
                icon={passwordVisible.reenter ? faEyeSlash : faEye}
              />
            </span>
            {passwords.reenter && passwords.create !== passwords.reenter && (
